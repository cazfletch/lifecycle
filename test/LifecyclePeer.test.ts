...
describe('LifecyclePeer', () => {
    ...
    describe('getAllInstalledSmartContracts', () => {
        ...
        it('should get all the installed smart contracts', async () => {
            ...
            const result: InstalledSmartContract[] = await peer.getAllInstalleSmartContracts();
        ...
        it('should install the smart contract package using the timeout passed in', async () => {
            ...
            const result: InstalledSmartContract[] = await peer.getAllInstalleSmartContracts(4321);
            result.should.deep.equal([{packageId: 'myPackageId', label: 'myLabel'}, {
                packageId: 'anotherPackageId',
                label: 'anotherLabel'
            }]);
        ...
        it('should handle wallet or identity not being set', async () => {
            peer['wallet'] = undefined;
            peer['identity'] = undefined;
            await peer.getAllInstalleSmartContracts().should.eventually.be.rejectedWith('Wallet or identity property not set, call setCredentials first');
        });

        it('should handle identity not being in the wallet', async () => {
            peer['identity'] = 'otherIdentity';
            await peer.getAllInstalleSmartContracts().should.eventually.be.rejectedWith('Could not get all the installed smart contract packages, received: Identity otherIdentity does not exist in the wallet');
        });
        ...
        it('should handle errors in the response', async () => {
            ...
            await peer.getAllInstalleSmartContracts().should.eventually.be.rejectedWith('Could not get all the installed smart contract packages, received: some error');
        ...
        it('should handle a non 200 status code', async () => {
            ...
            await peer.getAllInstalleSmartContracts().should.eventually.be.rejectedWith('Could not get all the installed smart contract packages, received: query failed with status:400 ::some error');
        ...
        it('should handle no response details', async () => {
            ...
            await peer.getAllInstalleSmartContracts().should.eventually.be.rejectedWith('Could not get all the installed smart contract packages, received: Query has failed');
        ...
        it('should handle no response', async () => {
            ...
            await peer.getAllInstalleSmartContracts().should.eventually.be.rejectedWith('Could not get all the installed smart contract packages, received: No response returned for query');
