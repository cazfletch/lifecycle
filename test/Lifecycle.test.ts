...
import {Endorser, Client, Committer} from 'fabric-common';
...
describe('Lifecycle', () => {
    ...
    describe('addOrderer', () => {
        ...
        it('should add an orderer', () => {
            ...
            const committer: Committer = fabricClient.getCommitter('myOrderer', 'osmsp');
            committer.endpoint['url'].should.equal('grpcs://localhost:7050');
        });
